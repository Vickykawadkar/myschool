  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#0F172A] text-white font-mono">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50">
        <div className="flex justify-between items-center px-6 py-4 backdrop-blur-md bg-[#0F172A]/80 border-b border-[#334155] transition-all duration-300" 
             style={{ boxShadow: scrollY > 20 ? '0 4px 20px rgba(0, 0, 0, 0.3)' : 'none' }}>
